...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'AddlistPage',
          path: '/addlistPage',
          builder: (context, params) => AddlistPageWidget(),
        ),
        FFRoute(
          name: 'mainpage',
          path: '/mainpage',
        ...
        FFRoute(
          name: 'UselistPage',
          path: '/uselistPage',
          builder: (context, params) => UselistPageWidget(),
        ),
        FFRoute(
          name: 'informationPage',
          path: '/informationPage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'informationPage')
        ...
        FFRoute(
          name: 'transPage',
          path: '/transPage',
          builder: (context, params) => TransPageWidget(),
        ),
        FFRoute(
          name: 'registerPage',
          path: '/registerPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => UseFoodTransactionCheckWidget(
            ...
            foodPercentage: params.getParam(
              'foodPercentage',
              ParamType.double,
            ),
        ...
        FFRoute(
          name: 'viewBackupPhrasePage',
          path: '/viewBackupPhrasePage',
          builder: (context, params) => ViewBackupPhrasePageWidget(),
        )
