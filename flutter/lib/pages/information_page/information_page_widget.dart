                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        context
                                            .pushNamed('viewBackupPhrasePage');
                                      },
                                      text: '查看助記詞',
                                      options: FFButtonOptions(
                                        width: 140.0,
                                ...
                                child: ExpandableNotifier(
                                  ...
                                  child: ExpandablePanel(
                                    ...
                                    collapsed: Container(
                                      ...
                                      child: FutureBuilder<ApiCallResponse>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final columnAccountallResponse =
                                              snapshot.data!;

                                          return Builder(
                                            builder: (context) {
                                              final accounts = getJsonField(
                                                columnAccountallResponse
                                                    .jsonBody,
                                                r'''$.account''',
                                              ).toList();
                                    ...
                                    expanded: Container(
                                      ...
                                      decoration: BoxDecoration(),
                                      child: FutureBuilder<ApiCallResponse>(
                                        future: GetAccountTransCall.call(
                                          baseURL: FFAppState().baseURL,
                                          groupId: FFAppState().groupid,
                                        ),
                                        builder: (context, snapshot) {
                                          ...
                                          final columnGetAccountTransResponse =
                                              snapshot.data!;

                                          return Builder(
                                            builder: (context) {
                                              final accountTrans = getJsonField(
                                                columnGetAccountTransResponse
                                                    .jsonBody,
                                                r'''$.transactions''',
                                              ).toList();
                                    ...
                                    theme: ExpandableThemeData(
                                      ...
                                      hasIcon: true,
                                      expandIcon: Icons.change_circle_outlined,
                                      collapseIcon: Icons.change_circle_sharp,
